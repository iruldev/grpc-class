...
const (
	LaptopService_CreateLaptop_FullMethodName = "/grpc.class.LaptopService/CreateLaptop"
	LaptopService_SearchLaptop_FullMethodName = "/grpc.class.LaptopService/SearchLaptop"
	LaptopService_UploadImage_FullMethodName  = "/grpc.class.LaptopService/UploadImage"
	LaptopService_RateLaptop_FullMethodName   = "/grpc.class.LaptopService/RateLaptop"
)
...
type LaptopService_UploadImageClient interface {
	...
	CloseAndRecv() (*UploadImageRespons, error)
	grpc.ClientStream
}
...
func (x *laptopServiceUploadImageClient) CloseAndRecv() (*UploadImageRespons, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(UploadImageRespons)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type LaptopService_UploadImageServer interface {
	SendAndClose(*UploadImageRespons) error
...
func (x *laptopServiceUploadImageServer) SendAndClose(m *UploadImageRespons) error {
	return x.ServerStream.SendMsg(m)
}
...
var LaptopService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.class.LaptopService",
