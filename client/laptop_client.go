...
func NewLaptopClient(cc *grpc.ClientConn) *LaptopClient {
	return &LaptopClient{service: proto.NewLaptopServiceClient(cc)}
}

func (c *LaptopClient) CreateLaptop(laptop *proto.Laptop) {
...
func (c *LaptopClient) SearchLaptop(filter *proto.Filter) {
...
func (c *LaptopClient) UploadImage(laptopID, imagePath string) {
